...
Notez que bien que le premier point *touche* le polygone, il n'est pas à l'intérieur de celui-ci ; le troisième point est à l'intérieur du polygone mais ne touche aucune partie de sa frontière.
...
Remarquez que bien que le point 4 soit à une unité de distance du nœud le plus proche de `polygon_sfc` (au point 2 de la figure \@ref(fig:relation-objets)), il est quand même sélectionné lorsque la distance est fixée à 0,9.
Ceci est illustré dans le morceau de code ci-dessous, qui montre que chaque point se trouve à moins de 0,2 unité du polygone.
