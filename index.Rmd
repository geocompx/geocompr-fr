...
if (is_on_ghactions){
    cat(paste0("Cette version du livre en français a été produite via l'action GitHub du ", Sys.Date(), "."))
} else {
    cat(paste0("Cette version du livre en français a été produite le ", Sys.Date(), "."))
}
```
...
```{r index-2-4, echo=FALSE, fig.cap="Capture d'écran du code reproductible contenu dans Geocomputation avec R s'exécutant dans RStudio Server sur un navigateur servi par Binder.", eval=is_html}
...
# Pendant l'écriture en cours de la seconde édition vous aurez peut être aussi besoin
# des version de développement de certains paquets :
...
Pour ce faire, vous devez [télécharger](https://github.com/Robinlovelace/geocompr/archive/refs/heads/main.zip) puis dézipper, ou [cloner](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository), le code source du livre.
...
# Est-ce que geocompkg est installé ?
geocompkg_is_installed = "geocompkg" %in% installed.packages()
if(!geocompkg_is_installed){
  message(
  'geocompkg n´est pas installé, éxecuter\nremotes::install_github("geocompr/geocompkg") # pour l´intsaller'
  )
} 
```
...
- en [le citant](https://github.com/Robinlovelace/geocompr/raw/main/CITATION.bib) ou  [le mettre en lien](https://geocompr.robinlovelace.net/),
- en '[Starring](https://help.github.com/articles/about-stars/)' le [dépôt GitHub geocompr](https://github.com/robinlovelace/geocompr),
- en écrivant un avis, sur Amazon ou [Goodreads](https://www.goodreads.com/book/show/42780859-geocomputation-with-r)
- en posant des questions ou en faisant des suggestions de contenus sur [GitHub](https://github.com/Robinlovelace/geocompr/issues/372) ou Twitter,
- [en achetant](https://www.amazon.com/Geocomputation-R-Robin-Lovelace-dp-0367670577/dp/0367670577) une copie.
