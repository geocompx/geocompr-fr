...
```{r asia, out.width='50%', fig.cap="L'Asia surajoutée comme une couche par dessus les pays mondiaux.", eval=FALSE}
...
```{r contpop, fig.cap="Pays coloriés par continents et leurs populations en  2015 populations (cercles proportionnels à la population).", echo=FALSE, warning=FALSE, fig.scap="Pays par continents et leur population en 2015."}
...
```{r china, fig.cap="L'Inde et les pays avoisinants, demonstration de l'argument the expandBB.", warning=FALSE, echo=FALSE, out.width="50%"}
...
```{r raster-intro-plot, echo = FALSE, fig.cap = "Données raster types: (A) identifiant des pixels, (B) Valeur des pixels, (C) une carte raster colorisée.", fig.scap="Raster data types.", fig.asp=0.5, message=FALSE}
